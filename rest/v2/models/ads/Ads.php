...
class Ads
{
  ...
  public function filterActive()
  {
    try {
      $sql = "select * from {$this->tblAds} ";
      $sql .= "where ads_is_active = :ads_is_active ";
      $sql .= "order by ads_is_active desc, ";
      $sql .= "ads_title ";
      $query = $this->connection->prepare($sql);
      $query->execute([
  ...
  public function filterActiveSearch()
  {
    ...
    return $query;
      ...
      public function readAllActiveAds()
      {
          try {
              $sql = "select * from {$this->tblAds} ";
  ...
  // {
  //   try {
  //     $sql = "select ads_title from {$this->tblAds} ";
