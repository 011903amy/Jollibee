...
const ModalCart = () => {
  return (
    <div className='fixed top-0 left-0 w-full h-screen'>
      <div className='backdrop w-full h-full bg-black bg-opacity-70 absolute top-0 left-0'>
      </div>
      ...
      {/* <div className='max-w-[600px] w-full bg-white rounded-md absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden'>
           ...
           <div className='grid grid-cols-3 gap-4 h-[60vh] overflow-y-auto custom-scroll'>
            ...
            {Array.from(Array(10).keys()).map((i)=>(
              ...
              <ul className='flex items-center gap-4 justify-center'>
                <li><button className='grid size-[30px] place-content-center bg-primary text-white rounded-full'><Plus size={16}/></button></li>
                <li>0</li>
                <li><button className='grid size-[30px] place-content-center bg-primary text-white rounded-full'><Minus size={16}/></button></li>
              </ul>
            </div>
            ))}
        ...
        <div className='modal-summary absolute bottom-0 left-0 w-full p-4 bg-white flex justify-between items-center shadow-[0_10px_30px_rgba(0,0,0,_0.4)]'>
          <h3 className='mb-0'>Total: P1000</h3>
      ...
      <div className='modal-main h-[60vh] w-full flex justify-center items-center'>
        <div className='flex flex-col items-center'>
          <img src={`${imgPath}/jollibee-logo.png`} alt="" className='mx-auto mb-5 w-[100px]' />

          <p className='text-2xl mb-5 font-bold'>Select preferred dining option</p>
        
        <button className='bg-primary p-x-6 py-4 w-[250px] flex justify-center gap-2 font-bold text-white items-center rounded-md'><Utensils/>Dine In</button>
        
        <h3 className='my-3'>or</h3>
        
        <button className='bg-primary p-x-6 py-4 w-[250px] flex justify-center gap-2 font-bold text-white items-center rounded-md'><ShoppingBag/>Take Out</button>
        </div>
      ...
      <div className='modal-main h-[60vh] w-full flex justify-center items-center'>
        ...
        <button className='bg-primary p-x-6 py-4 w-[250px] flex justify-center gap-2 font-bold text-white items-center rounded-md'><PhilippinePeso />Cash Payment</button>
        
        <h3 className='my-3'>or</h3>
        
        <button className='bg-primary p-x-6 py-4 w-[250px] flex justify-center gap-2 font-bold text-white items-center rounded-md'><CreditCard />Card/Online Payment</button>
        </div>
