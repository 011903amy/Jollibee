...
const ModalSuccess = () => {
  ...
  return (
    <>
      <div
        className={`drop-shadow-2xl fixed z-[99] top-10 left-1/2 -translate-x-1/2 flex items-center justify-between w-full gap-2 max-w-sm p-4 mb-4 text-black bg-white rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)] transform duration-200 ease-in-out ${animate}`}
      >
